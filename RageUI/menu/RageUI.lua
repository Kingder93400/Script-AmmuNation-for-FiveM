...
-- [[ SOURCE RAGEUI V2 BY ANUBIS , menu plus agrandit ect au style de la v1 :)))))) 
...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 480, Height = 107 },
            Text = { X = 250, Y = 20, Scale = 1.15 },
        },
        Subtitle = {
            Background = { Width = 480, Height = 37 },
            Text = { X = 8, Y = 3, Scale = 0.35 },
            PreText = { X = 475, Y = 3, Scale = 0.35 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 480 },
        Navigation = {
            Rectangle = { Width = 480, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 480, Height = 4 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 480, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.35 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 480, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 480, Height = 76 },
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                DrawScaleformMovie(ScaleformMovie, GlareX, GlareY, Glarewidth / 540, Glareheight / 100, 255, 255, 255, 255, 0)
            end
