...
local SettingsButton = {
    Rectangle = { Y = 0, Width = 480, Height = 38 },
    Text = { X = 8, Y = 3, Scale = 0.33 },
    LeftBadge = { Y = -2, Width = 40, Height = 40 },
    RightBadge = { X = 440, Y = -2, Width = 40, Height = 40 },
    RightText = { X = 470, Y = 4, Scale = 0.35 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 480, Height = 38 },
}
